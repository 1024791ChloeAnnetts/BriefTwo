...
public class DanceTeam : MonoBehaviour
{
    ...
    {
        allDancers.Add(dancer); // This adds in 1 dancer.
        activeDancers.Add(dancer); // This adds it to the active dancers list.
    ...
    {
        activeDancers.Remove(dancer); // This removes the dead team mate.
